...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val (sleepTrackerViewModel, adapter) = ViewModelProvider(this, viewModelFactory)
            .get(SleepTrackerViewModel::class.java).let { vm ->
                val adapter = SleepNightAdapter(SleepNightListener { vm.onSleepNightClicked(it) })
                ...
                vm.navigateToSleepDetail.observe(viewLifecycleOwner, Observer { nighId ->
                    nighId?.let {
                        findNavController().navigate(
                            SleepTrackerFragmentDirections.actionSleepTrackerFragmentToSleepDetailFragment(it)
                        )
                        vm.onNavigateToSleepDetailComplete()
                    }
                })
